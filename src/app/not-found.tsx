    ...
    <div className="min-h-screen bg-brand-surface dark:bg-background flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        <div className="relative inline-block mb-8">
          ...
          <div className="relative bg-card border border-brand-border h-32 w-32 rounded-3xl flex items-center justify-center mx-auto shadow-2xl rotate-3">
            <FileQuestion className="w-16 h-16 text-brand-primary animate-bounce" />
          </div>
        </div>

        <h1 className="text-6xl font-serif font-bold text-brand-text mb-4">404</h1>
        <h2 className="text-xl font-bold text-brand-text mb-3">Halaman Tidak Ditemukan</h2>
        <p className="text-brand-muted text-sm leading-relaxed mb-10">
          Maaf, halaman yang kamu cari tidak ada atau telah dipindahkan. Silakan periksa kembali URL
